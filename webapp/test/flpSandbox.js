		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Output Determination: Printer per User",
									"targetURL": "#comboschrb1mtmtmtnadu-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comboschrb1mtmtmtnadu-display": {
								"semanticObject": "comboschrb1mtmtmtnadu",
								"action": "display",
								"description": "Output Determination: Printer per User",
								"title": "Output Determination: Printer per User",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bosch.rb1m.tm.tmtnadu",
									"url": sap.ui.require.toUrl("com/bosch/rb1m/tm/tmtnadu")
								}
							}
						}
					}
